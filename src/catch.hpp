...
namespace Catch {
    ...
    struct IConfig : NonCopyable {
        ...
        virtual bool skipBenchmarking() const = 0;
...
#undef CATCH_CONFIG_DEFAULT_REPORTER
    ...
    public:
        ...
        bool skipBenchmarking() const override;
...
namespace Catch {
    ...
    clara::Parser makeCommandLineParser(ConfigData& config) {
        ...
        ("amount of time in milliseconds spent on warming up each test (default: 100)")
            ...
            | Opt(config.skipBenchmarking, "skipBenchmarking")
    		["--skip-benchmarking"]["--skip-benchmarks"]["--skip-benchmark"]["--tests-only"]
    		("Skip all benchmarking and only run tests.");
...
namespace Catch {
    ...
    bool Config::skipBenchmarking() const { return m_data.skipBenchmarking; }
